...
function writeIdentityDocs(targetRoot, projectName) {
  ...
  writeRelative(
    ...
    markdown([
      ...
      "sources once per turn. It is not a watcher or per-tool hook. Review changed hook hashes through",
      "`/hooks`; no script may approve them automatically.",
      "",
  ...
  writeRelative(
    ...
    markdown([
      ...
      "changed indexed sources once per turn; semantic search repairs freshness on demand. See",
  ...
  writeRelative(
    ...
    markdown([
      ...
      "16. Unsafe scoping, missing upstream/authentication, unresolved integration, or rejection blocks closure without force-pushing.",
