...
export const requiredPortableContractFiles = new Set([
  ...
  "pnpm-lock.yaml",
  "pnpm-workspace.yaml",
  "scripts/context/context-chunks.mjs",
  "scripts/context/context-embedding.mjs",
  "scripts/context/context-hashing.mjs",
  "scripts/context/context-lock.mjs",
  "scripts/context/context-paths.mjs",
  "scripts/context/context-ranking.mjs",
