...
import { nonPortableSnapshotPathReason } from "./portable-project-contract.mjs";
import { ensureProductSourceBoundary } from "./stage-project-export.mjs";
...
export function copyPortableSetupFixture(targetRoot, { sourceRoot = root } = {}) {
  ...
  ensureProductSourceBoundary(targetRoot);
}
